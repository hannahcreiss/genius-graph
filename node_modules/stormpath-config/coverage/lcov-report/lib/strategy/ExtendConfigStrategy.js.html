...
&nbsp;
  // TODO: Also a hack. Same as the one above.
  <span class="missing-if-branch" title="if path not taken" >I</span>if(this.extendWith &amp;&amp; this.extendWith.web &amp;&amp; <span class="branch-2 cbranch-no" title="branch not covered" >this.extendWith.web.spa)</span>{
<span class="cstat-no" title="statement not covered" >    config.web.spa = this.extendWith.web.spa;</span>
  }
&nbsp;
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Thu Feb 18 2016 22:36:36 GMT+0100 (CET)
</div>
</div>
